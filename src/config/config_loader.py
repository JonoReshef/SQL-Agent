...
class ProductDefinition(BaseModel):
    ...
    properties: List[PropertyDefinition] = Field(default_factory=list, description="Product properties")
...
class ExtractionRules(BaseModel):
    ...
    quantity_patterns: List[str] = Field(
        ...
        description="Regex patterns for quantity extraction"
    )
    date_formats: List[str] = Field(
        default_factory=list,
        description="Date format strings for parsing"
    )
...
class ProductConfig(BaseModel):
    ...
    products: List[ProductDefinition] = Field(..., description="List of product definitions")
