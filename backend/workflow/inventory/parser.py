...
from workflow.config.config_loader import format_config, load_config
from workflow.llm.client import get_llm_client
...
from workflow.models.product import ProductItemResult
from workflow.utils.property_enrichment import enrich_properties_with_metadata
...
def parse_inventory_batch(
    ...
    while len(stored_missed_items) > 0:
        ...
        stored_missed_items = [
            item
            for item in stored_missed_items
