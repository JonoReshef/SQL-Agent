...
from workflow.analysis_workflow.nodes.matching.utils.hierarchy import (
    get_hierarchy_for_category,
)
from workflow.config.config_loader import load_config
from workflow.models.configs import ProductConfig
...
def enrich_properties_with_metadata(
    ...
    if hierarchy is not None:
        ...
        property_order = {
            prop_name: idx for idx, prop_name in enumerate(hierarchy.property_order)
        }
