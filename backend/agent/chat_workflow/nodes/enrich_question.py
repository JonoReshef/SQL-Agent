    ...
    response = QuestionEnrichment.model_validate(
        LLM.invoke(
            enriched_content.format(
                ...
                previous_queries=state.messages[
                    :-1
                ],  # Placeholder for actual previous queries
